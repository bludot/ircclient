...
/***/ function(module, exports, __webpack_require__) {
	...
	var data = {
	    ...
	    msgListener: {
	        ...
	        parseUsers: function parseUsers(users) {
	...
	var Messages = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var messageNodes = function messageNodes(room, msgs) {
	            var room = room;
	            return msgs.map(function (msg) {
	                ...
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        'time',
	                        null,
	                        msg.time.toUTCString().match(/\d+?:\d.+?:\d.+?/)[0]
	                    ),
	                    React.createElement(
	                        'span',
	                        null,
	    ...
	    render: function render() {
	        ...
	        if (this.props.data.current_room != null) {
	            users = this.props.data.data[this.props.data.current_room].users.map(function (user) {
	                ...
	                return React.createElement(
	                    'li',
	                    { className: 'user_list', style: parent_style },
	...
	var App = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(Left_side, { data: this.props.data }),
	            React.createElement(MainArea, { data: this.props.data }),
	            React.createElement(Right_side, { data: this.props.data })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getScrollbarWidth = __webpack_require__(168);

	var _getScrollbarWidth2 = _interopRequireDefault(_getScrollbarWidth);

	var _returnFalse = __webpack_require__(169);

	var _returnFalse2 = _interopRequireDefault(_returnFalse);

	var _getInnerWidth = __webpack_require__(170);

	var _getInnerWidth2 = _interopRequireDefault(_getInnerWidth);

	var _getInnerHeight = __webpack_require__(171);

	var _getInnerHeight2 = _interopRequireDefault(_getInnerHeight);

	var _styles = __webpack_require__(172);

	var _defaultRenderElements = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toSpace = __webpack_require__(9);
