...
/***/ function(module, exports, __webpack_require__) {
	...
	var Messages = React.createClass({
	    ...
	    render: function render() {
	        var messageNodes = function messageNodes(msgs) {
	...
	var Input = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement('input', { type: 'text', value: this.state.value, onInput: this.handleInput, onKeyUp: this.handleKeyUp });
	    }
	});
